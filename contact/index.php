...
<title> Contact Team Segura</title>
...
<?php
    ...
    $messagew = wordwrap($message, 70);

    // send mail

    mail("teamsegura@kems.com","Team Segura - Contact Form: $name","Name: $fieldname \n Found: $field1 \n Phone #: $field2 \n Email: $field3 \n Needs: $comments \n ");
	...
	echo "<p>Thank you for contacting Team Segura";
	echo "</div></div>";
